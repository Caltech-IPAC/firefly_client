...
class FireflyClient:
    ...
    NO_VIEWER = "NO_VIEWER"
    _viewer_modes: ClassVar = [TRIVIEW_VIEWER, SLATE_VIEWER, NO_VIEWER]
    ...
    def __init__(
        ...
        self.auth_headers = (
            {"Authorization": "Bearer {}".format(token)} if token and ssl else None
        )
